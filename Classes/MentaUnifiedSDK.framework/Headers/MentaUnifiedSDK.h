...
#import <MentaUnifiedSDK/MentaUnifiedEnum.h>
...
//! Project version string for MentaUnifiedSDK.
FOUNDATION_EXPORT const unsigned char MentaUnifiedSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <MentaUnifiedSDK/PublicHeader.h>
